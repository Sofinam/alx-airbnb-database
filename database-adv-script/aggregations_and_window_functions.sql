1. Total number of bookings made by every user
...
2. Rank properties by total number

SELECT property_id, total_bookings, ROW_NUMBER() OVER (ORDER BY total_bookings DESC) AS property_rank
